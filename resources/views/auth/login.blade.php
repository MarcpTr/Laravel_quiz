...
@section('content')
    ...
    <form method="POST" action="{{ route('login') }}" class="bg-blue-300 w-96 flex flex-col place-items-center h-fit rounded-2xl space-y-6 pt-3 pb-16 text-white">
        <div class="text-4xl">Inicia sesión</div>
                            @csrf
       <div class="relative">
                                        ...
                                        <input type="text" id="login" name="login" value="{{ old('login') }}" required autocomplete="login"
                                    ...
                                    @foreach (['password', 'login'] as $field)
                                        ...
                                        @enderror
                                    @endforeach
                                    <a class="hover:underline hover:text-blue-600 m-4" href="{{ route('register') }}">¿No tienes una cuenta?, Registrate desde aquí</a>
                                </div>
                            </div>
                        </form>
